...
public sealed partial class MechGrabberUiFragment : BoxContainer
{
    ...
    public void UpdateContents(MechGrabberUiState state)
    {
        ...
        ItemList.Clear(); // <MechGrabber-edited>
        for (var i = 0; i < state.Contents.Count; i++)
        {
            ...
            var item = ItemList.AddItem(meta.EntityName); // <MechGrabber-edited>
            item.OnSelected += _ => OnEjectAction?.Invoke(ent); // <MechGrabber-edited>
        }
    }
}
