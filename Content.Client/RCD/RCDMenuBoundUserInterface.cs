...
public sealed partial class RCDMenuBoundUserInterface : BoundUserInterface
{
    ...
    private static readonly Dictionary<string, (string Tooltip, SpriteSpecifier Sprite)> PrototypesGroupingInfo
        = new()
        {
            ...
            // <Onyx-RPD>
            ["Piping"] = ("rcd-component-piping", new SpriteSpecifier.Texture(new ResPath("/Textures/_Onyx/Interface/Radial/RPD/fourway.png"))),
            ["AtmosphericUtility"] = ("rcd-component-atmosphericutility", new SpriteSpecifier.Texture(new ResPath("/Textures/_Onyx/Interface/Radial/RPD/port.png"))),
            ["PumpsValves"] = ("rcd-component-pumpsvalves", new SpriteSpecifier.Texture(new ResPath("/Textures/_Onyx/Interface/Radial/RPD/pump_volume.png"))),
            ["Vents"] = ("rcd-component-vents", new SpriteSpecifier.Texture(new ResPath("/Textures/_Onyx/Interface/Radial/RPD/vent_passive.png"))),
            // </Onyx-RPD>
        };
