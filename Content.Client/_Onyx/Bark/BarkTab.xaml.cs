...
namespace Content.Client._Onyx.Bark;
...
public sealed partial class BarkTab : Control
{
    ...
    private void BuildCategoryButtons()
    {
        ...
        foreach (var category in _barksByCategory.Keys.OrderBy(c => c))
        {
            ...
            var localizedCategory = _localization.TryGetString($"bark-category-{category}", out var localized)
                ? localized 
                : category;
    ...
    private void SelectCategory(string? category)
    {
        ...
        var displayName = category == null 
            ? "Все барки" 
            : (_localization.TryGetString($"bark-category-{category}", out var localized) ? localized : category);
        ...
        foreach (var button in buttons)
        {
            ...
            else
            {
                ...
                var buttonCategory = category != null && _localization.TryGetString($"bark-category-{category}", out var loc) ? loc : category;
