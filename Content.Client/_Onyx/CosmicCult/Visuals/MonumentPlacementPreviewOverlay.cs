...
namespace Content.Client._Onyx.CosmicCult.Visuals;

public sealed class MonumentPlacementPreviewOverlay : Overlay
{
    private static readonly ProtoId<ShaderPrototype> SaturationShader = "SaturationShuffle";
    private static readonly ProtoId<ShaderPrototype> MonumentShader = "MonumentPulse";
        ...
        string? starState = null)
    {
        ...
        var mainRsiPath = mainPath ?? new ResPath("_Onyx/CosmicCult/Tileset/monument.rsi");
        ...
        _saturationShader = protoMan.Index(SaturationShader).InstanceUnique();
        _saturationShader.SetParameter("tileSize", new Vector2(96, 96));
        _saturationShader.SetParameter("hsv", new Vector3(1.0f, 0.25f, 0.2f));

        _starsShader = protoMan.Index(MonumentShader).InstanceUnique();
        _starsShader.SetParameter("tileSize", new Vector2(96, 96));

        _unshadedShader = protoMan.Index(UnshadedShader).Instance(); //doesn't need a unique instance
