...
humanoid-profile-editor-width-label = Build (kg):
humanoid-profile-editor-dimension-reset = Reset
humanoid-profile-editor-calculated-weight-label = Calculated weight: { $weight } kg
