...
delivery-unlocked-self = You unlock the {$delivery} with your ID card.
delivery-opened-self = You open the {$delivery}.
delivery-unlocked-others = {CAPITALIZE($recipient)} unlocked the {$delivery} with {POSS-ADJ($possadj)} ID card.
