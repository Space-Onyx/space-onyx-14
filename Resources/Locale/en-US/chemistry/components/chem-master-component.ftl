...
chem-master-window-search-reagent-label = Search:
chem-master-window-search-reagent-placeholder = Reagent name
chem-master-window-search-in-containers = In containers
...
chem-master-window-search-no-results-text = No reagents match the search.
