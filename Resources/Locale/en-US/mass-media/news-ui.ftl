...
news-read-ui-back-text = ← Back
news-read-ui-back-tooltip = Return to article list
news-read-ui-default-title = Station News
news-read-ui-articles-list-title = News Articles List
news-read-ui-not-found-text = No articles found
news-read-ui-time-prefix-text = Publication time:
news-read-ui-read-article = Read Article
