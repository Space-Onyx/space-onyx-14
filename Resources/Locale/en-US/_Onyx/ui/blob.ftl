...
blob-no-using-guns-popup = You cannot use guns.
...
blob-verb-upgrade = Upgrade Blob
...
blob-title = Blob
blob-description = Blob infection starts aboard station. Contain it before it reaches critical mass.
role-subtype-blob = Blob
store-currency-display-blob-points = Blob points
