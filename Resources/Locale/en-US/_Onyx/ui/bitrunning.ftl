...
bitrunning-ui-domain-reward-label = Reward: { $reward }
bitrunning-ui-domain-modular = Modular domain
bitrunning-ui-domain-secondary-objectives = Secondary objectives available
