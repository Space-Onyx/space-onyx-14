...
ent-ClothingModsuitCivilian = civilian modsuit control unit
    .desc = A lightweight controller for civilian use.
ent-ClothingModsuitCosmohonk = cosmohonk modsuit control unit
    .desc = A controller from Honk Ltd. Most of its technology went into reducing power consumption.
ent-ClothingModsuitRescue = rescue modsuit control unit
    .desc = An advanced medical controller designed for rescue in hazardous environments.
ent-ClothingModsuitCivilianPowerCell = { ent-ClothingModsuitCivilian }
    .suffix = Battery
    .desc = { ent-ClothingModsuitCivilian.desc }
ent-ClothingModsuitCosmohonkPowerCell = { ent-ClothingModsuitCosmohonk }
    .suffix = Battery
    .desc = { ent-ClothingModsuitCosmohonk.desc }
ent-ClothingModsuitRescuePowerCell = { ent-ClothingModsuitRescue }
    .suffix = High-Capacity Battery
    .desc = { ent-ClothingModsuitRescue.desc }
