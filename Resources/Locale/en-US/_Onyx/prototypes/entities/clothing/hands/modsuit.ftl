...
ent-ClothingModsuitGauntletsCivilian = civilian modsuit gauntlets
    .desc = Lightweight civilian gauntlets for everyday tasks.
ent-ClothingModsuitGauntletsCosmohonk = cosmohonk modsuit gauntlets
    .desc = Clown-themed gauntlets. Perfect for delivering honks.
ent-ClothingModsuitGauntletsRescue = rescue modsuit gauntlets
    .desc = Rescue gauntlets with partial electrical insulation.
