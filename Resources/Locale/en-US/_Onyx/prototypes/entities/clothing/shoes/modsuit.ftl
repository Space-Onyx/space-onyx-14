...
ent-ClothingModsuitBootsCivilian = civilian modsuit boots
    .desc = Lightweight civilian boots comfortable for extended wear.
ent-ClothingModsuitBootsCosmohonk = cosmohonk modsuit boots
    .desc = Clown-themed boots that honk with every step.
ent-ClothingModsuitBootsRescue = rescue modsuit boots
    .desc = Rescue boots designed for rapid response and patient evacuation.
