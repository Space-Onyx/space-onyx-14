...
ent-ClothingModsuitChestplateCivilian = civilian modsuit chestplate
    .desc = A lightweight civilian chestplate offering minimal protection and maximum mobility.
ent-ClothingModsuitChestplateCosmohonk = cosmohonk modsuit chestplate
    .desc = A clown-themed chestplate. Surprisingly durable for something so silly.
ent-ClothingModsuitChestplateRescue = rescue modsuit chestplate
    .desc = A rescue chestplate with excellent environmental protection.
