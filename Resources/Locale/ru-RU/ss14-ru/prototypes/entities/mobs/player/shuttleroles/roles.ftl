...
ent-RandomHumanoidVisitorAtmosTech = посетитель атмосферный техник роль призрака
    .desc = { "" }
ent-RandomHumanoidVisitorTechnicalAssistant = роль призрака посетителя инженера-стажёра
    .desc = { "" }
...
ent-RandomHumanoidVisitorDentist = посетитель стоматолог роль призрака
    .desc = { "" }
ent-RandomHumanoidVisitorResearchAssistant = роль призрака посетителя лаборанта
    .desc = { "" }
