...
humanoid-profile-editor-width-label = Телосложение (кг):
humanoid-profile-editor-dimension-reset = Сброс
humanoid-profile-editor-calculated-weight-label = Расчётный вес: { $weight } кг
