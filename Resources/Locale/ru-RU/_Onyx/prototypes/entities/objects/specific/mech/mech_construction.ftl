...
ent-GygaxChassis = шасси Гигакса
    .desc = Незавершённая конструкция меха Гигакс со всеми установленными частями тела.
