...
ent-SlotMachineFlatpack = упакованная слот-машина
    .desc = Упаковка, при помощи которой можно собрать слот-машину.
ent-SlotMachineHighRollerFlatPack = упакованная личная слот-машина
    .desc = Упаковка, при помощи которой можно собрать личную слот-машину.
ent-CoinFlipperFlatPack = упакованная флип-машина
    .desc = Упаковка, при помощи которой можно собрать флип-машину.
ent-ClawMachineFlatPack = упакованная кран-машина
    .desc = Упаковка, при помощи которой можно собрать кран-машину.
