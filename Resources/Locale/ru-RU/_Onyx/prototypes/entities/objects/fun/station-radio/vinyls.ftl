...
ent-VinylDiskForgotten = забытая виниловая пластинка
    .desc = Часть пластинки отсутствует, но что-то вам подсказывает, что она до сих пор способна проигрывать музыку. Но... стоит ли?
...
ent-VinylSleeveDJClown = конверт для пластинки «DJ Клоун»
    .desc = DJ Клоун - галактическая знаменитость. За свои рейвы горячо любим хонко-мамой.
