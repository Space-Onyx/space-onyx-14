...
ent-ActionVampireBloodTendrils = [color=purple]Щупальца из крови[/color]
    .desc = Призовите кровавые щупальца, чтобы поразить своих врагов.
ent-ActionVampireBloodBarrier = [color=purple]Кровавый барьер[/color]
    .desc = Создайте барьер, который защитит вас.
ent-ActionVampireSanguinePool = [color=purple]Кровавый бассейн[/color]
    .desc = Превратись в лужу.
ent-ActionVampirePredatorSenses = [color=purple]Чутьё охотника[/color]
    .desc = Ваше чутье подскажет вам, где находится ближайшая жертва.
ent-ActionVampireBloodEruption = [color=purple]Извержение крови[/color]
    .desc = Лужи крови вокруг вас будут извергаться и наносить урон вашим врагам.
ent-ActionVampireBloodBringersRite = [color=purple]Обряд крови[/color]
    .desc = Проведите кровавый обряд и превратите это место в кровавую баню!

# Umbrae
ent-ActionVampireCloakOfDarkness = [color=purple]Плащ тьмы[/color]
    .desc = Спрячьтесь в темноте.
ent-ActionVampireShadowSnare = [color=purple]Теневая ловушка[/color]
    .desc = Поставьте невидимую ловушку.
ent-ActionVampireSoulAnchor = [color=purple]Маяк души[/color]
    .desc = Создайте маяк, который позволит вам вернуться к нему.
ent-ActionVampireDarkPassage = [color=purple]Теневой проход[/color]
    .desc = Перемещение в пространстве.
ent-ActionVampireExtinguish = [color=purple]Потушить[/color]
    .desc = Погасите свечи.
ent-ActionVampireShadowBoxing = [color=purple]Бой с тенью[/color]
    .desc = Призовите тень, которая поможет вам в битве.
ent-ActionVampireEternalDarkness = [color=purple]Вечная темнота[/color]
...
ent-ActionVampireBloodRush = [color=purple]Прилив крови[/color]
    .desc = Вы чувствуете прилив крови, вы становитесь быстрее.
ent-ActionVampireSeismicStomp = [color=purple]Сейсмический топот[/color]
    .desc = Сильный удар, который отбросит всех вокруг.
ent-ActionVampireBloodSwellAdvanced = [color=purple]Нарастание крови[/color]
    .desc = Твоя кровь густеет, ты становишься сильнее.
ent-ActionVampireOverwhelmingForce = [color=purple]Ошеломляющая сила[/color]
    .desc = Твоя сила превосходна, теперь тебя нельзя заковать в кандалы, и двери открываются как спички.
ent-ActionDemonicGrasp = [color=purple]Демоническая хватка[/color]
    .desc = Схвати своего недоброжелателя.
ent-ActionVampireCharge = [color=purple]Рывок[/color]
    .desc = Сделайте рывок.
...
ent-ActionCommune = [color=purple]Общение[/color]
    .desc = Общение со своими подчиненными.
ent-ActionPacify = [color=purple]Умиротворение[/color]
