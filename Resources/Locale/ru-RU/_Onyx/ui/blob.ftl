...
blob-no-using-guns-popup = Вы не можете использовать оружие.
...
blob-verb-upgrade = Улучшить блоб
...
blob-title = Блоб
blob-description = На станции начинается заражение блобом. Сдержите его до достижения критической массы.
