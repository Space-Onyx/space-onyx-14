...
bitrunning-ui-domain-reward-label = Награда: { $reward }
bitrunning-ui-domain-modular = Модульный домен
bitrunning-ui-domain-secondary-objectives = Доступны дополнительные цели
