...
rogue-ascended-infection-notification = { CAPITALIZE($user) } протягивает свои щупальца к { $target }!
rogue-ascended-infection-briefing =
    Зловещая энергия пропитывает вашу душу. Вы были заражены Астральным вознесённым!
    Ищите духовное очищение, пока его влияние не подчинило вас полностью.
