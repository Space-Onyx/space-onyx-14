clone-projector-examined-status =
    { $cloneStatus ->
        [true] Клон сейчас активен.
       *[false] Клон сейчас неактивен.
    }
...
gemini-projector-regenerate-verb = Регенерировать клона
...
ghost-role-information-monozygotic-clone-description = Помогайте Центральному командованию в выполнении любых задач.
