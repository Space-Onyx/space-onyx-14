...
news-read-ui-back-text = ← Назад
news-read-ui-back-tooltip = Вернуться к списку статей
news-read-ui-default-title = Новости станции
news-read-ui-articles-list-title = Список новостных статей
news-read-ui-not-found-text = Статей не найдено
news-read-ui-time-prefix-text = Время публикации:
news-read-ui-read-article = Читать статью
