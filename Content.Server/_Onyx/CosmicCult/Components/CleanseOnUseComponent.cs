...
public sealed partial class CleanseOnUseComponent : Component
{
    ...
    [DataField]
    public SoundSpecifier CleanseSound = new SoundPathSpecifier("/Audio/_Onyx/CosmicCult/cleanse_deconversion.ogg");

    [DataField]
    public SoundSpecifier MalignSound = new SoundPathSpecifier("/Audio/_Onyx/CosmicCult/glyph_trigger.ogg");
