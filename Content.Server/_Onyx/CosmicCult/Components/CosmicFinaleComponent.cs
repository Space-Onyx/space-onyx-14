...
public sealed partial class CosmicFinaleComponent : Component
{
    ...
    [DataField]
    public SoundSpecifier BufferMusic = new SoundPathSpecifier("/Audio/_Onyx/CosmicCult/premonition.ogg");

    [DataField]
    public SoundSpecifier FinaleMusic = new SoundPathSpecifier("/Audio/_Onyx/CosmicCult/a_new_dawn.ogg");
