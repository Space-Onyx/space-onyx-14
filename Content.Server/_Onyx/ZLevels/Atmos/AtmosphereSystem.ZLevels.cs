...
public sealed partial class AtmosphereSystem
{
        ...
        out GasMixture? mixture)
    {
        ...
        var worldPos = XformSystem.GetWorldPosition(entity.Comp); // <Onyx-ZLevels-edited>
        ...
        foreach (var grid in _mapSystem.GetAllGrids(entity.Comp.MapID)) // <Onyx-ZLevels-edited>
        {
    ...
    private bool HasZLevelTileBelow(
        ...
        Vector2i gridTile)
    {
        return HasAnySolidZLevelTileBelow(ent.Owner, ent.Comp3, gridTile);
    }
        ...
        Vector2i gridTile)
    {
        ...
        var aboveXform = Transform(aboveGridUid);
        ...
        int depthOffset)
    {
        ...
        // ExcitedGroups are tracked per-grid; can't span across linked grids without breaking
        // ExcitedGroupMerge's grid-locality assertion. Skip the group attachment here and accept
        // that LastShareCheck cooldown bookkeeping is a no-op on cross-grid z-shared tiles.
        ...
        out TileAtmosphere otherTile)
    {
        ...
        var otherXform = Transform(otherGridUid);
        ...
        out Vector2i belowTile)
    {
        ...
        // Require a solid tile anywhere below (through consecutive holes),
        ...
        return TryGetImmediateLevelBelow(ent.Owner, ent.Comp3, gridTile, out belowGridUid, out belowGrid, out belowTile);
    }
