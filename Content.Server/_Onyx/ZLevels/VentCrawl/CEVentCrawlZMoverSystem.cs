...
namespace Content.Server._Onyx.ZLevels.VentCrawl;

/// <summary>
/// Lets vent-crawlers move between matching multi-z pipe adapters.
/// </summary>
public sealed partial class CEVentCrawlZMoverSystem : EntitySystem
{
    ...
    [Dependency] private SharedVentCrawableSystem _ventCraw = default!;
