...
using Content.Shared._Onyx.ZLevels.Ladders.Components;
...
namespace Content.Server._Onyx.ZLevels.Ladders;

public sealed partial class CEZLevelLadderSystem : EntitySystem
{
    ...
    private static readonly SpriteSpecifier UpIcon = new SpriteSpecifier.Rsi(new ResPath("/Textures/_Onyx/Actions/zLevels.rsi"), "up");
    private static readonly SpriteSpecifier DownIcon = new SpriteSpecifier.Rsi(new ResPath("/Textures/_Onyx/Actions/zLevels.rsi"), "down");
