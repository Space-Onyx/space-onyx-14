...
namespace Content.Server._Onyx.ZLevels.Weightless;

/// <summary>
/// Grants ghost-style z-level movement actions while a living mob is floating in weightlessness.
/// </summary>
public sealed partial class CEWeightlessZLevelMoverSystem : EntitySystem
{
    ...
    public override void Update(float frameTime)
    {
        ...
        foreach (var uid in _zLevels.ActiveBodies)
        {
            ...
            UpdateActions(uid, physics, Transform(uid));
        }
    }
