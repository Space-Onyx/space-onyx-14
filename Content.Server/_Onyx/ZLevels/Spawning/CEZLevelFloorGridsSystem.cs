...
namespace Content.Server._Onyx.ZLevels.Spawning;

/// <summary>
/// Resolves the station floor grids used by multiz spawners.
/// </summary>
public sealed partial class CEZLevelFloorGridsSystem : EntitySystem
{
    [Dependency] private IRobustRandom _random = default!;
    [Dependency] private StationSystem _station = default!;

    /// <summary>
    /// Returns the station's normal main grid without map-prototype configuration.
    /// </summary>
