...
public sealed partial class BlobNodeSystem : EntitySystem
{
    ...
    private readonly HashSet<EntityUid> _cleanedNodes = new();
    ...
    private void OnDestruction(EntityUid uid, BlobNodeComponent component, DestructionEventArgs args)
    {
        ...
        {
            if (tile.Comp.Core == null || tile.Comp.Core.Value.Owner != tileComp.Core.Value.Owner)
                continue;
