...
public sealed partial class BlobCarrierSystem : SharedBlobCarrierSystem
{
    ...
    public override void Initialize()
    {
        ...
        SubscribeLocalEvent<BlobCarrierComponent, CollectLanguageKnowledgeEvent>(OnApplyLang);
    ...
    private void OnApplyLang(Entity<BlobCarrierComponent> ent, ref CollectLanguageKnowledgeEvent args)
    {
    ...
    private void OnRemove(Entity<BlobCarrierComponent> ent, ref ComponentRemove args) => _language.UpdateLanguages(ent.Owner);
