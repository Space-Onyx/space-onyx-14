...
public sealed partial class RespiratorSystem : EntitySystem
{
    ...
    public override void Update(float frameTime)
    {
        ...
        while (query.MoveNext(out var uid, out var respirator))
        {
            ...
            // <Onyx-GoobGrab-edited>
            if (!_mobState.IsIncapacitated(uid) && !choked && !breathingBlocked) // cannot breathe in crit or while choked. // <Onyx-MartialArts-edited>
            // </Onyx-GoobGrab-edited>
            {
            ...
            {
                // <Onyx-MissingHead-edited>
                if (!HasComp<MissingHeadComponent>(uid) &&
