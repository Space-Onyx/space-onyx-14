...
using Content.Server.Voting.Managers; // <Onyx-AutomaticVotes>
...
using Content.Shared.Voting; // <Onyx-AutomaticVotes>
...
using Timer = Robust.Shared.Timing.Timer; // <Onyx-AutomaticVotesDelay>
...
public sealed partial class ServerGameTicker
{
    ...
    [Dependency] private IVoteManager _voteManager = default!; // <Onyx-AutomaticVotes>
