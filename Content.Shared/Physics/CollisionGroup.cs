...
public enum CollisionGroup
{
    ...
    // Humanoids, etc.
    MobMask = Impassable | HighImpassable | MidImpassable | LowImpassable | BlobImpassable, // <Onyx-Blob-edited>
    MobLayer = Opaque | BulletImpassable,
    // Mice, drones
    SmallMobMask = Impassable | LowImpassable | BlobImpassable, // <Onyx-Blob-edited>
    SmallMobLayer = Opaque | BulletImpassable,
    // Birds/other small flyers
    FlyingMobMask = Impassable | HighImpassable | BlobImpassable, // <Onyx-Blob-edited>
    FlyingMobLayer = Opaque | BulletImpassable,

    // Mechs
    LargeMobMask = Impassable | HighImpassable | MidImpassable | LowImpassable | BlobImpassable, // <Onyx-Blob-edited>
    LargeMobLayer = Opaque | HighImpassable | MidImpassable | LowImpassable | BulletImpassable,

    // Machines, computers
    MachineMask = Impassable | MidImpassable | LowImpassable | BlobImpassable, // <Onyx-Blob-edited>
    ...
    TableMask = Impassable | MidImpassable | BlobImpassable, // <Onyx-Blob-edited>
    TableLayer = MidImpassable,

    // Tabletop machines, windoors, firelocks
    TabletopMachineMask = Impassable | HighImpassable | BlobImpassable, // <Onyx-Blob-edited>
    // Tabletop machines
    ...
    ThrownItem = Impassable | HighImpassable | BulletImpassable | BlobImpassable, // <Onyx-Blob-edited>
