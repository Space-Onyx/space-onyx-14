...
{
    public abstract T Core { get; set; }
    public abstract T Invalid { get; set; }
    public abstract T Resource { get; set; }
    public abstract T Factory { get; set; }
    public abstract T Node { get; set; }
    public abstract T Reflective { get; set; }
    public abstract T Strong { get; set; }
    public abstract T Normal { get; set; }
    /*
    [DataField]
...
*/
    ...
    public bool ContainsKey(BlobTileType key)
    {
        return key is >= BlobTileType.Invalid and <= BlobTileType.Core;
    }

    public bool TryGetValue(BlobTileType key, out T value)
    {
