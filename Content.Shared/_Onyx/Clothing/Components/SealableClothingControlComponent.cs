...
public sealed partial class SealableClothingControlComponent : Component
{
    ...
    [DataField]
    public SoundSpecifier FailSound = new SoundPathSpecifier("/Audio/_Onyx/Machines/ErrorBeep2.wav");

    [DataField]
    public SoundSpecifier SealCompleteSound = new SoundPathSpecifier("/Audio/_Onyx/Mecha/nominal.ogg");

    [DataField]
    public SoundSpecifier UnsealCompleteSound = new SoundPathSpecifier("/Audio/_Onyx/Machines/computer_end.ogg");

    [DataField]
    public SoundSpecifier GenericSuitWarning = new SoundPathSpecifier("/Audio/_Onyx/Machines/MaxTempAlertCut.wav");
    #endregion
}
