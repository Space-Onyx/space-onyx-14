...
using System.Linq;
using Content.Shared._Onyx.Salvage.Bosses.Audio;
...
namespace Content.Shared._Onyx.Salvage.Bosses.Aggression;
...
public sealed partial class AggressorsSystem : EntitySystem
{
    ...
    public override void Initialize()
    {
        ...
        SubscribeLocalEvent<AggressiveComponent, DamageDealtEvent>(OnDamageChanged);
    ...
    private void OnDamageChanged(Entity<AggressiveComponent> ent, ref DamageDealtEvent args)
    {
