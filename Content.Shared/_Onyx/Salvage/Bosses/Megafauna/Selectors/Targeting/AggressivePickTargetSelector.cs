...
using Content.Shared._Onyx.Salvage.Bosses.Megafauna.Conditions.Targeting;
using Content.Shared._Onyx.Salvage.Bosses;
...
public sealed partial class AggressivePickTargetSelector : MegafaunaSelector
{
    ...
    protected override float InvokeImplementation(MegafaunaCalculationBaseArgs args)
    {
        ...
        if (WeightedRandom)
            picked = WeightedPicker.Pick(results, args.Random);
        else
        {
