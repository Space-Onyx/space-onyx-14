...
using Content.Shared._Onyx.Salvage.Bosses.Aggression;
using Content.Shared._Onyx.Salvage.Bosses.Anger.Components;
using Content.Shared._Onyx.Salvage.Bosses.Megafauna.Events;
using Content.Shared._Onyx.Salvage.Bosses.MobPhases;
...
namespace Content.Shared._Onyx.Salvage.Bosses.Anger.Systems;
...
public sealed partial class AngerSystem : EntitySystem
{
    ...
    public override void Initialize()
    {
        ...
        SubscribeLocalEvent<AngerComponent, DamageDealtEvent>(OnDamaged);
    ...
    public void UpdateAggression(Entity<AngerComponent?, AggressiveComponent?> ent)
    {
        ...
        var healthProgress = Math.Max((float) (anger.AccumulatedDamage / (anger.TotalHp * healthMultiplier)), 0f);
    ...
    private void OnDamaged(Entity<AngerComponent> ent, ref DamageDealtEvent args)
    {
