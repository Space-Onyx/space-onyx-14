...
namespace Content.Shared._Onyx.Xenomorphs.TailLash;

public sealed partial class SharedTailLashSystem : EntitySystem
{
    ...
    private void OnTailLashActionEvent(EntityUid uid, TailLashComponent component, ref TailLashActionEvent args)
    {
        ...
        foreach (var hit in hitEntities)
        {
            ...
            foreach (var (reagent, amount) in component.Inject)
                _solutionContainer.TryAddReagent(solutionEnt.Value, reagent, amount, out _);
        }
