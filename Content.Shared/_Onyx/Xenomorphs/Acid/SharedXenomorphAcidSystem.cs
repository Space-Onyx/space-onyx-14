...
namespace Content.Shared._Onyx.Xenomorphs.Acid;
...
public abstract partial class SharedXenomorphAcidSystem : EntitySystem
{
    ...
    [Dependency] private PlasmaCostActionSystem _plasmaCost = default!; // Goobstation
    ...
    private void OnXenomorphAcidActionEvent(EntityUid uid, XenomorphAcidComponent component, AcidActionEvent args)
    {
        ...
        if (!HasComp<StructureComponent>(args.Target))
        {
