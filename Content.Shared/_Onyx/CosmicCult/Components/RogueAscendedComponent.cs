...
public sealed partial class RogueAscendedComponent : Component
{
    ...
    [DataField]
    public SoundSpecifier InfectionSfx = new SoundPathSpecifier("/Audio/_Onyx/CosmicCult/ability_nova_impact.ogg");

    [DataField]
    public SoundSpecifier ShatterSfx = new SoundPathSpecifier("/Audio/_Onyx/CosmicCult/ascendant_shatter.ogg");

    [DataField]
    public SoundSpecifier MobSound = new SoundPathSpecifier("/Audio/_Onyx/CosmicCult/ascendant_noise.ogg");
