...
public sealed partial class CCVars
{
    ...
    public static readonly CVarDef<int>
        CEZLevelsMaxOpeningRectsPerPass = CVarDef.Create("zlevels.ce_max_opening_rects_per_pass", 512, CVar.CLIENTONLY | CVar.ARCHIVE);

    public static readonly CVarDef<float>
        CEZLevelsLowerRenderVisibilityGrace = CVarDef.Create("zlevels.ce_lower_render_visibility_grace", 0.18f, CVar.CLIENTONLY | CVar.ARCHIVE);

    public static readonly CVarDef<bool>
        CEZLevelsCullOccludedDynamicSprites = CVarDef.Create("zlevels.ce_cull_occluded_dynamic_sprites", true, CVar.CLIENTONLY | CVar.ARCHIVE);
    ...
    /// Server-authoritative and replicated so rendering and cross-Z projectile routing use the
    /// same value. 0 stacks decks with no offset. Default 0.3.
    /// </summary>
    public static readonly CVarDef<float>
        CEZLevelsRenderOffset = CVarDef.Create("zlevels.ce_render_offset", 0.3f, CVar.SERVER | CVar.REPLICATED | CVar.ARCHIVE);

    /// <summary>
    /// Blur radius for rendered lower Z-levels. Server-authoritative and replicated. 0 disables
    /// blur sampling while retaining lower-level ambient tint. Default 2.
    /// </summary>
    public static readonly CVarDef<float>
        CEZLevelsBlurRadius = CVarDef.Create("zlevels.ce_blur_radius", 2f, CVar.SERVER | CVar.REPLICATED | CVar.ARCHIVE);
