...
public sealed partial class CEZLinkedGridComponent : Component
{
    ...
    /// <summary>
    /// Identity of this physical linkage. Usually the map network; connector-built structures use
    /// their runtime grid-network entity so independent structures in one Z-stack stay isolated.
    /// </summary>
    [DataField, AutoNetworkedField]
    public EntityUid LinkNetwork;
