...
public sealed partial class CEZItemPhysicsComponent : Component
{
    ...
    /// <summary>
    /// Server-only transition waiting for the shared per-tick transition budget. -1 is down, 1 is up.
    /// Velocity is preserved while the item waits at the level boundary.
    /// </summary>
    [ViewVariables]
    public sbyte PendingTransition;
