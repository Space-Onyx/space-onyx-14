...
public abstract partial class CESharedZLevelsSystem
{
    ...
    /// <summary>
    /// Finds exact sight-opening bounds intersecting a world-space region.
    /// </summary>
    public bool TryFindOpeningBounds(
        ...
        List<Entity<MapGridComponent>> gridScratch)
    {
        var foundOpening = _openingCache.TryFindOpeningBounds(
            mapId,
            worldBounds,
            openingBounds,
            out _,
        ...
        return gridScratch.Count == 0 || foundOpening;
    }
