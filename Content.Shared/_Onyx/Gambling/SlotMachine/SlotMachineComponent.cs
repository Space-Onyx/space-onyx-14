...
public sealed partial class SlotMachineComponent : Component
{
    ...
    [DataField]
    public SoundSpecifier SpinSound = new SoundPathSpecifier("/Audio/_Onyx/Machines/SlotMachine/slotmachine_spin.ogg");
    ...
    [DataField]
    public SoundSpecifier BigWinSound = new SoundPathSpecifier("/Audio/_Onyx/Machines/SlotMachine/slotmachine_bigwin.ogg");

    [DataField]
    public SoundSpecifier JackPotWinSound = new SoundPathSpecifier("/Audio/_Onyx/Machines/SlotMachine/slotmachine_jackpotwin.ogg");

    [DataField]
    public SoundSpecifier GodPotWinSound = new SoundPathSpecifier("/Audio/_Onyx/Machines/SlotMachine/slotmachine_godpot.ogg");
